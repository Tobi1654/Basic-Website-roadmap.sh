...
Live Preview: http://127.0.0.1:5500/basicwebsite.html
...
```bash
git clone https://github.com/Tobi1654/portfolio-website.git
```
...
3. Open `basicwebsite.html` in your browser:
```bash
# On macOS
...
# On Linux
xdg-open basicwebsite.html
```

## 📄 Pages Overview

### Home Page (`basicwebsite.html`)
...
### Articles Page (`articlepage.html`)
...
Oluwatobi Olanrele - [@Tobi1654](https://github.com/Tobi1654)

Project Link: [https://github.com/Tobi1654/portfolio-website](https://github.com/Tobi1654/portfolio-website)
